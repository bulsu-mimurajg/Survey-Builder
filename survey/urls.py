...
urlpatterns = [
    ...
    path('teacher/survey-board/', views.teacher_survey_board, name='teacher-survey-board'),
    path('teacher/survey/create/', views.teacher_create_survey, name='teacher-create-survey'),
    path('teacher/survey/<int:survey_id>/builder/', views.teacher_survey_builder, name='teacher-survey-builder'),
